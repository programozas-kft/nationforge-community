...
MD,
        ...
        foreach ($articles as $menuKey => $data) {
    ...
    {
        $keys = ['fooldal', 'kapcsolatok', 'esemenyek', 'csoportok', 'adományok', 'felhasznalok', 'beallitasok'];
        DB::table('help_articles')->whereIn('menu_key', $keys)->update([
            'title_en'   => null,
            'content_en' => null,
        ]);
    }
