    ...
    <div class="nf-card">
        ...
        <div class="divide-y" style="border-color:#f3f3f9">
            ...
            <div class="px-5 py-3 flex items-center gap-3" style="padding-left:20px; padding-right:20px;">
                ...
                @endphp
                <span class="nf-badge {{ $sc[$person->status] ?? 'badge-secondary' }}" style="white-space:nowrap;flex-shrink:0">
    ...
    <div class="nf-card p-5 lg:col-span-2">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-4 text-xs text-gray-500">
                <span class="flex items-center gap-1"><span style="display:inline-block;width:12px;height:3px;background:#405189;border-radius:2px"></span> {{ __('dashboard.contacts_label') }}</span>
                <span class="flex items-center gap-1"><span style="display:inline-block;width:12px;height:3px;background:#0ab39c;border-radius:2px"></span> {{ __('dashboard.donations_label') }}</span>
            </div>
        </div>
