...
@section('header-actions')
    ...
    <form method="POST" action="{{ route('admin.events.publish-facebook', $event) }}" class="inline">
        @csrf
        <button type="submit" class="btn-ghost"
                style="display:inline-flex;align-items:center;gap:5px;border-color:#1877F2;color:#1877F2"
                title="{{ __('integrations.fb_publish_btn') }}">
            ...
            {{ __('integrations.fb_publish_btn') }}
        </button>
    </form>
    @endif
