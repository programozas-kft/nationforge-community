...
@section('title', 'Linkgyűjtemény')
@section('header', 'Linkgyűjtemény')
@section('breadcrumb') <span style="color:#495057">Linkgyűjtemény</span> @endsection
...
<div class="nf-card" style="padding:60px;text-align:center">
    ...
    <p style="color:#adb5bd;font-size:0.9rem">Még nincsenek linkek. <a href="{{ route('admin.settings') }}#links" style="color:#405189">Adj hozzá egyet a Beállításokban.</a></p>
</div>
@else
